...
#ifndef SIMILARITY_PEARSON_H
#define SIMILARITY_PEARSON_H

/**
 * Clase SimilarityPearson
 * @brief Clase que implementa la similitud de Pearson
 */
class SimilarityPearson : public Similarity {
 public:
  /**
    ...
    */
  double calculateSimilarities(const std::vector<double>& x, const std::vector<double>& y, double min_val) const override { return SimilarityFunctions::correlacionPearson(x, y, min_val); }
};
