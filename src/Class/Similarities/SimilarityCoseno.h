...
#ifndef SIMILITUDCOSENO_H
#define SIMILITUDCOSENO_H

/**
 * Clase SimilarityCoseno
 * @brief Clase que implementa la similitud coseno
 */
class SimilarityCoseno : public Similarity {
 public:
  /**
    ...
    */
  double calculateSimilarities(const std::vector<double>& x, const std::vector<double>& y, double min_val) const override { return SimilarityFunctions::similitudCoseno(x, y, min_val); }
};
